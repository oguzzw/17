...
import { FaSteam, FaSpotify, FaDiscord, FaVolumeUp, FaVolumeMute, FaSnowflake, FaTiktok, FaInstagram, FaGithub, FaYoutube } from 'react-icons/fa';
...
const Kintaro = () => {
    ...
    const socialLinks = [
        { icon: <FaDiscord className="kintaro-icon" />, text: 'Discord', url: 'https://discord.gg/zsEKCXYBeF' },
        { icon: <FaYoutube className="kintaro-icon" />, text: 'Youtube', url: 'https://youtube.com/@oguzx7?si=F-4e4-uCzLOSReVp' },
        { icon: <FaGithub className="kintaro-icon" />, text: 'Github', url: 'https://github.com/oguzzw' },
    ];
    ...
    return (
        <div className="kintaro-container">
            ...
            <div className="kintaro-profile-card">
                ...
                <h2 className="kintaro-username">oguz</h2>
                <p className="kintaro-bio">
                    Merhaba! Ben oguz. Bu benim kişisel portfolyo sitem. Burada benim hakkımda daha fazla bilgi bulabilirsiniz.
                </p>
